...
#SBATCH --job-name=job_fusion35-low-nocap
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/fusion35-low-nocap.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/fusion35-low-nocap.err
#SBATCH --get-user-env
#SBATCH --export=NONE
...
snakemake -call all --configfile /dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/config/config.fusion35-low-nocap.yaml
if [ $? -ne 0 ]; then
