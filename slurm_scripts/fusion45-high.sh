...
#SBATCH --job-name=job_fusion45-high
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/fusion45-high.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/fusion45-high.err
#SBATCH --get-user-env
#SBATCH --export=NONE
...
snakemake -call all --configfile /dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/config/config.fusion45-high.yaml
if [ $? -ne 0 ]; then
