...
#SBATCH --job-name=job_ref-10co2
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/ref-10co2.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/ref-10co2.err
#SBATCH --get-user-env
#SBATCH --export=NONE
...
snakemake -call all --configfile /dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/config/config.reference-10co2.yaml
if [ $? -ne 0 ]; then
