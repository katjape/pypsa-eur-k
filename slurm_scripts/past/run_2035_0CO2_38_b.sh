...
#SBATCH --job-name=job_test_2035
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/test_2035.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/test_2035.err
#SBATCH --get-user-env
#SBATCH --export=NONE
...
export GUROBI_HOME="/dss/dsshome1/05/05/ga27hek2/miniforge3/envs/pypsa-eur"
...
# -------------------------------------------------------------------------------------------------------------------------------
# Job KA2 -  Fusion in 2035, 10e-6, All countries, 0 CO2, Base costs
# -------------------------------------------------------------------------------------------------------------------------------
echo "Running Snakemake..."
snakemake -call all --configfile /dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/config/config.yaml
if [ $? -ne 0 ]; then
