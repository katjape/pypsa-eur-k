...
#SBATCH --job-name=job_b_eu_10e-6_38_katja_teramem_45
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/b_eu_10e-6_38_katja_teramem_45.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/b_eu_10e-6_38_katja_teramem_45.err
#SBATCH --get-user-env
#SBATCH --export=NONE
...
cd /dss/dsshome1/05/ge87say3/pypsa-eur-k-2/ || { echo "Failed to navigate to project directory. Exiting."; exit 1; }
...
snakemake -call all --configfile /dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/config/base/config.b_eu_10e-6_38_45.yaml
if [ $? -ne 0 ]; then
