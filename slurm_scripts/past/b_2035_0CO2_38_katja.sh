...
#SBATCH --job-name=job_b_2035_0CO2_38_katja
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/b_2035_0CO2_38_katja.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/b_2035_0CO2_38_katja.err
#SBATCH --get-user-env
#SBATCH --export=NONE
...
snakemake -call all --configfile /dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/config/config_2035.yaml
if [ $? -ne 0 ]; then
