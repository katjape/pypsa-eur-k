...
#SBATCH --job-name=job_b_core_10e-6_38_koni_teramem
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/b_core_10e-6_38_koni_teramem.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/b_core_10e-6_38_koni_teramem.err
#SBATCH --get-user-env
#SBATCH --export=NONE
...
cd /dss/dsshome1/05/05/ga27hek2/pypsa-eur-k-1/ || { echo "Failed to navigate to project directory. Exiting."; exit 1; }
...
# -------------------------------------------------------------------------------------------------------------------------------
# Job KO1 -  Fusion 2035, 10e-6, All countries, 0 CO2, Base costs, 950 gb RAM
# -------------------------------------------------------------------------------------------------------------------------------
