...
#SBATCH --job-name=job_2035_0CO2_39_low
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/run_2035_0CO2_39_low.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/run_2035_0CO2_39_low.err
#SBATCH --get-user-env
#SBATCH --export=NONE
