...
#SBATCH --job-name=job_testrun-ref
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/testrun-ref.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/slurm_error/testrun-ref.err
#SBATCH --get-user-env
#SBATCH --export=NONE
...
snakemake --configfile /dss/dssfs02/lwp-dss-0001/pn39ci/pn39ci-dss-0000/MA_Git/config/config.reference.yaml --forcerun plot_summary
if [ $? -ne 0 ]; then
